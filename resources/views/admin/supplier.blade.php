   ...
   <div class="content">
        <div class="row">
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Add New Suppliers</h5>
              </div>
              <div class="card-body">
                <form action="/addnewsupplier" method="post">
                  @csrf
                  <div class="row">
                    ...
                    <div class="col-md-6 pr-2">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Address" name="supplieraddress">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-6 pr-2">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Supplier Phone Number" name="phonenumber">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="Supplier Credit Time" name="time">
                      </div>
                    </div>
                    <div class="col-md-6 pr-2">
                      <div class="form-group">
                        <label>Supplier Pan Number </label>
                        <input type="text" class="form-control" placeholder="Supplier Pan Number" name="pan">
                      </div>
                    </div>
                  </div>
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Supplier's Details
                </h4>
                  ...
                  <table class="table" id="suppliertable">
                    <thead class=" text-primary">
                      ...
                      <tr>
                        ...
                        <td>
                          {{$datas->supplier_address}}
                        </td>
                        <td>
                          {{$datas->supplier_email}}
                        </td>
                        <td>
                          {{$datas->supplier_phone}}
                        </td>
                        <td>
                          {{$datas->supplier_pan_no}}
                        </td>
                        <td>
                          {{$datas->supplier_credit_time_days}}
                        </td>
                        <td>
