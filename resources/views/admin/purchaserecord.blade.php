...
@section('session')
  ...
  <strong>Success!</strong> New Purchase Record Successfully
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Add New Purchase Records</h5>
              </div>
              <div class="card-body">
              	<form action="/purchasedatasubmit" method="post">
                  @csrf
                  <div class="row">
                    <div class="col-md-6 pr-2">
                      <div class="form-group">
                        <label>Supplier Name</label>
                         <select class="form-control" id="supplierlist" name="suppliername">
